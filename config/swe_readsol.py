...
funh = FunH.BUMP2#STEP#BUMP2#D# BUMPS
H_noise_factor = 0
perturb_init = InitCond.PERT_NONE#DISC#PERT_RIEMANN#DISC#PERT_WB #PERT_NONE
boundary = BoundaryCond.SUBCR#SUPER_RE#FORCE_STEADY_INIT#FORCE_DISCRETE_STEADY_INIT#SUBCR#SUPER#FORCE_DISCRETE_STEADY_INIT#SUPER#_RE#SUBCR#SUBCR_RE#IN_OUT #FORCE_STEADY_INIT
