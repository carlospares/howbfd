...
boundary = BoundaryCond.SUPER_RE#FORCE_STEADY_INIT#FORCE_DISCRETE_STEADY_INIT#SUBCR#SUPER#FORCE_DISCRETE_STEADY_INIT#SUPER#_RE#SUBCR#SUBCR_RE#IN_OUT #FORCE_STEADY_INIT
