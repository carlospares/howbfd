...
perturb_init = InitCond.PERT_NONE      # see initcond.py, PERT_NONE to omit
sw_h = Equation.SWE_H_PWPOLY           # see equation.py
sw_H_noise_factor = 0.1                # see equation.py, 0 to no noise
...
eqn = Equation(equation, xGhost, sw_h, sw_H_noise_factor)
initCond = InitCond(init, eqn, perturb_init)
...
tag = io_manager.get_tag(init, perturb_init, equation, numflux,
