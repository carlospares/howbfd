...
plot(w3_upwind_n100(:,1),(w3_upwind_n100(:,2)-w3_upwind_n100(:,6))-(w3_upwind_n100_stationary(:,2)-w3_upwind_n100_stationary(:,6)),'linewidth',1.5)
hold on
plot(w3_upwind_n100(:,1),(w3_am8_n100(:,2)-w3_am8_n100(:,6))-(w3_am8_n100_stationary(:,2)-w3_am8_n100_stationary(:,6)),'linewidth',1.5)
plot(w3_am6_n100(:,1),(w3_am6_n100(:,2)-w3_am6_n100(:,6))-(w3_am6_n100_stationary(:,2)-w3_am6_n100_stationary(:,6)),'linewidth',1.5)
plot(w3_am4_n100(:,1),(w3_am4_n100(:,2)-w3_am4_n100(:,6))-(w3_am4_n100_stationary(:,2)-w3_am4_n100_stationary(:,6)),'linewidth',1.5)
...
legend('upind no wb','AM3','AM4','AM6')
 ...
 str=['weno3_sup_DISCsmall_n100_error_h_t0'];
 savefig(str);
