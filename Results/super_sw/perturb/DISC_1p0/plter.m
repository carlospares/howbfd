...
%--eta
plot(w3_upwind_n100(:,1),w3_upwind_n100(:,4),'linewidth',1.5)
hold on
plot(w3_upwind_n100(:,1),w3_am8_n100(:,4),'linewidth',1.5)
plot(w3_am6_n100(:,1),w3_am6_n100(:,4),'linewidth',1.5)
plot(w3_am4_n100(:,1),w3_am4_n100(:,4),'linewidth',1.5)
...
% str=['weno3_sup_DISCbig_n100_eta'];
% savefig(str);
