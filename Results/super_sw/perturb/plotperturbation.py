...
# Loading data
w3am4 = np.loadtxt('DISC_0p0001/Weno3_AM4_N100_T0p5.txt')
w3am6 = np.loadtxt('DISC_0p0001/Weno3_AM6_N100_T0p5.txt')
w3am8 = np.loadtxt('DISC_0p0001/Weno3_AM8_N100_T0p5.txt')
w3up = np.loadtxt('DISC_0p0001/Weno3_Upwind_N100_T0p5.txt')
...
plt.legend(loc='upper left',fontsize=11,framealpha=1.0)
plt.xlabel(r'$x$', fontsize=18)
plt.ylabel(r'$\eta-\eta_s$', fontsize=18)
plt.grid()
plt.axis([0, 25, -0.0005, 0.0005])
