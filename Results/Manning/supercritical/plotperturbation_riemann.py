...
# Loading data
w3am4 = np.loadtxt('weno5_am6_N100_riemann_nm0p05_T0p7.txt')
w3up = np.loadtxt('weno5_upwind_N100_riemann_nm0p05_T0p7.txt')
#w3up400 = np.loadtxt('weno5_upwind_N400_pert_T1.txt')
ref = np.loadtxt('reference_w7_am8_N800_riemann_nm0p05_T0p7.txt')
