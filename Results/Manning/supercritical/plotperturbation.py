...
# Loading data
w3am4 = np.loadtxt('weno5_am6_N100_pert_T0p7.txt')
#w3am6 = np.loadtxt('weno3_am6_N100_pert_T0p7.txt')
#w3am8 = np.loadtxt('weno3_am8_N100_pert_T0p7.txt')
w3up = np.loadtxt('weno5_upwind_N100_pert_T0p7.txt')
w3up400 = np.loadtxt('weno5_upwind_N400_pert_T0p7.txt')
ref = np.loadtxt('reference_w7_am8_N800_pert_T0p7.txt')
...
pertup400 = w3up400[:, 1] - analyticup400[:,3]
...
plt.legend(loc='upper left',fontsize=11,framealpha=1.0,ncol=1)
plt.xlabel(r'$x$', fontsize=18)
plt.ylabel(r'$\eta-\eta_s$', fontsize=18)
plt.grid()
plt.axis([0, 25, -0.0002, 0.0002])
...
plt.plot(w3up400[:, 0], w3up400[:, 4]-w3up400[:,2], '-b', linewidth=2, label='WENO5 (N=400)')
