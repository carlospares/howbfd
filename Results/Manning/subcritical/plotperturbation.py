...
# Loading data
w3am4 = np.loadtxt('weno5_am6_N100_pert_T1.txt')
#w3am6 = np.loadtxt('weno3_am6_N100_pert_T1.txt')
#w3am8 = np.loadtxt('weno3_am8_N100_pert_T1.txt')
w3up = np.loadtxt('weno5_upwind_N100_pert_T1.txt')
w3up400 = np.loadtxt('weno5_upwind_N400_pert_T1.txt')
ref = np.loadtxt('reference_w7_am8_N800_pert_T1.txt')
...
plt.plot(w3am4[:, 0], w3am4[:, 2], 'b', linewidth=2, label='$q_{in}$')
plt.plot(w3am4[:, 0], w3am4[:, 4], 'b', linewidth=2, label='$q$')
...
plt.legend(loc='lower right',fontsize=11,framealpha=1.0,ncol=2)
plt.xlabel(r'$x$', fontsize=18)
plt.ylabel(r'$\eta-\eta_s$', fontsize=18)
plt.grid()
plt.axis([0, 25, -0.0001, 0.0001])
