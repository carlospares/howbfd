...
ref = np.loadtxt('Riemann/reference_w7_am8_T1.dat')
...
#analytic_ref = np.loadtxt('../../../initial_data/analytical_sw/subcritical/initial_sub_5000.dat')
...
plt.legend(loc='lower left',fontsize=11,framealpha=1.0)
plt.xlabel(r'$x$', fontsize=18)
