...
# Loading data
w3am4 = np.loadtxt('DISC_0p0001/w3_am4_n100_T1p0.txt')
w3am6 = np.loadtxt('DISC_0p0001/w3_am6_n100_T1p0.txt')
w3am8 = np.loadtxt('DISC_0p0001/w3_am8_n100_T1p0.txt')
w3up = np.loadtxt('DISC_0p0001/w3_upwind_n100_T1p0.txt')
ref = np.loadtxt('DISC_0p0001/reference_w7_am8_T1p0.txt')
analytic4 = np.loadtxt('../Weno3_AM4/out100.txt')
analytic6 = np.loadtxt('../Weno3_AM6/out100.txt')
analytic8 = np.loadtxt('../Weno3_AM8/out100.txt')
analytic_ref = np.loadtxt('../../../Results/subcritical_sw/Weno3_AM8/out400.txt')
