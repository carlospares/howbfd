...
# Loading data
#w3 = np.loadtxt('Burgers/disc_steady/solution_W3_T1.txt')
...
#plt.plot(w3[:, 0], w3[:, 1], '--r', linewidth=3, label='reference')
plt.plot(w3[:, 0], w3[:, 3]-w3[:,5], 'b', linewidth=2, label='WBWENO3')
