...
# Loading data
w3am4 = np.loadtxt('DISC_0p0001/Weno3_AM4_N100_T1.txt')
w3am6 = np.loadtxt('DISC_0p0001/Weno3_AM6_N100_T1.txt')
w3am8 = np.loadtxt('DISC_0p0001/Weno3_AM8_N100_T1.txt')
w3up = np.loadtxt('DISC_0p0001/Weno3_Upwind_N100_T1.txt')
ref = np.loadtxt('DISC_0p0001/reference_W3_AM4_N5000_T1.txt')
...
zoom_axes = plt.axes([0.5, 0.4, 0.35, 0.35])  # Position in normalized units [left, bottom, width, height]
plt.box(on=True)
